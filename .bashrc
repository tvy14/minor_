...
alias soros='source /opt/ros/noetic/setup.bash'
...
#Scut for virtualenv
export vir1=/home/tim/federated/v1/bin/activate
alias edbsh="nano ~/.bashrc"
alias bashh="source ~/.bashrc"
alias python='/usr/bin/python3.8'
alias pip=pip3

alias gitgname="git config --global user.name"
alias gitgmail="git config --global user.email"
...
alias chsys="./sysinfo.sh"
alias synctime="sudo ntpdate -u"
